      ...
      <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            ...
            <a className="mr-5 hover:text-gray-900">Tratamientos</a>
            <a className="mr-5 hover:text-gray-900">Third Link</a>
            <a className="hover:text-gray-900">Fourth Link</a>
          </nav>
          <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
  <div className='w-20 bg-roseC rounded-full overflow-hidden'>
    <img className='w-full h-full object-cover' src={logoC} alt="logotipo de consultorio" />
  </div>
  <span className="ml-3 text-xl w-4/5 flex-1 whitespace-nowrap">Doctora Angeles Hermansson</span>
</a>
